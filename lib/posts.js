export const posts = [
  {
    ...
    summary:
      "Защо платената реклама в LinkedIn и Google Ads без SEO основа изгаря бюджета ви. Семантично ядро, пилар клъстери и AEO – пълното ръководство преди да пуснете първата си кампания.",
  },
  {
