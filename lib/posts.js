export const posts = [
  ...
  },
  {
    ...
    summary:
      "AI SEO услугите масово се продават като задължителни, но много от тях са преопакован маркетингов страх. Разбери кога наистина ти трябва отделна оптимизация за AI.",
  },
  {
