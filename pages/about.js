        ...
        <section className={styles.text}>
          <article className={styles.paragraph}>
            ...
            <section className={styles.strategySection} aria-labelledby="webdev-title">
              ...
              <p>
                Работя с <strong>WordPress</strong>, обикновен <strong>HTML/CSS</strong> и{" "}
                <strong>Next.js</strong> - три различни инструмента, всеки с точното си място
                в зависимост от мащаба, бюджета и целите на проекта. Независимо от избраната
