...
const About = () => {
  return (
    <>
      <Head>
        <title> За мен | Как се прави сайт за най-високо класиране в Google</title>
        <meta name="description" content="Успешно SEO гарантира благополучно представяне на сайта в мрежата, за да се вижда от всички навсякъде." />
      ...
      <div className={styles.main}>
        ...
        <section className={styles.text}>
          <div className={styles.paragraph}>
            <p>
              ...
              България. Занимавам се <Link href="/"><strong>Web development</strong></Link> от 2011 година. Завършил съм
            ...
            <p>
              Имам опит с <Link href="/how-to-make-site"><strong>изграждането на Web сайтове</strong></Link> в най-различни сфери от
        ...
        <section className={styles.text}>
          <div className={styles.paragraph}>
            <p>
              Убеден съм, че <Link href="/powerful-site"><strong>сайтовете трябва да се правят</strong></Link> от първия до
              ...
              до скорост на зареждане и най-приятно потребителско изживяване. Повече неща ще разказвам в <Link href="/blog"><strong>моя блог</strong></Link> 
            </p>
