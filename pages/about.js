          ...
          <article className={styles.paragraph}>
            ...
            <section className={styles.strategySection} aria-labelledby="casestudy-title">
              <h2 id="casestudy-title">
                Казус: Kolazascrap.com - от малка визитка до лидер в бранша
              </h2>
              <p>
                Най-убедителното доказателство за начина ми на работа не е в описания, а в
                резултатите, натрупани стъпка по стъпка. Ето как сайт с 4-5 страници се
                превърна в тематичен авторитет, доминиращ нишата.
              </p>
              <div className={styles.capabilityGrid4}>
                <article className={styles.capabilityCard}>
                  <h3>Изграждане от нулата</h3>
                  <p>
                    Сайтът стартира в <strong>WordPress</strong> с ясна семантична структура и
                    съдържание, организирано около реалните въпроси на хората, продаващи коли за
                    скрап. Фундаментът беше положен правилно от самото начало - техническа
                    изрядност, бърза скорост и мобилна оптимизация.
                  </p>
                </article>
                <article className={styles.capabilityCard}>
                  <h3>Редизайн и рекламна стратегия</h3>
                  <p>
                    ...
                    за скрап. Landing pages оптимизирани за конверсии - целта не е трафик, а
                    реални обаждания и запитвания.
                  </p>
                </article>
                <article className={styles.capabilityCard}>
                  <h3>Органично изкачване</h3>
                  <p>
                ...
                <article className={styles.capabilityCard}>
                  <h3>Калкулатор и тематично лидерство</h3>
                  <p>
