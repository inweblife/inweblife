      ...
      <main className={styles.main} id="main-content">
        ...
        <section className={styles.highlightSection} aria-labelledby="hero-expertise-title">
          <article className={styles.highlightCard}>
            ...
            <p>
              Изграждам сайтове с Next.js и{" "}
              <Link href="/wordpress-site">
                <strong>WordPress</strong>
              </Link>
              , оптимизирам ги за Google и управлявам Google Ads кампании с бюджети над милиони
              евро. С над 10 години опит работя по целия процес - от архитектурата на сайта до
              устойчивия органичен ръст и платения трафик.
            </p>
          </article>
        </section>
        ...
        <section className={styles.text}>
          <article className={styles.paragraph}>
            ...
            <p>
              ...
              от конкретни технически и съдържателни решения, взети още при{" "}
              <Link href="/izrabotka-na-sait">
                <strong>изработката на сайта</strong>
              </Link>
              . Бързо зареждане, ясна информационна архитектура, семантични клъстери от свързани теми и
        ...
        <section className={styles.expertArchitecture} aria-labelledby="expert-architecture-title">
          <article className={styles.highlightCard}>
            ...
            <p>
              ...
              системи, които доминират в класациите и са подготвени за бъдещето на AI търсенията.
            </p>
            <p>
