    ...
    <>
      ...
      <main className={styles.main} id="main-content">
        ...
        <article className={styles.article}>
          ...
          <section>
            <h2>Conversion архитектура — водене на посетителя от А до Б</h2>
            <p>
          ...
          <section>
            <h2>Trust сигнали — какво реално изгражда доверие онлайн</h2>
            <p>
          ...
          <section>
            <h2>PPC-ready сайт — преди да пуснете реклама в Гугъл</h2>
            <p>
          ...
          <section>
            <h2>Мощният сайт се измерва, не се предполага</h2>
            <p>
